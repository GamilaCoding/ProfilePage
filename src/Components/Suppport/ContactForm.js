...
const ContactForm = () => {
    ...
    return (
        <div className="contact-container">
            <h2 className="contact-header">تواصل معنا</h2>
            <p className="contact-description">
                تواصل معنا لمشاركة أسئلتك واقتراحاتك، فملاحظاتك محل اهتمامنا دائمًا.
            </p>
                ...
                {() => (
                    <Form className="contact-form">
                        <div className="form-group">
                            ...
                            <Field type="text" id="name" name="name" placeholder="أدخل الاسم بالكامل" />
                            <ErrorMessage name="name" component="div" className="error-message" />
                        </div>

                        <div className="form-group">
                            <label htmlFor="phone">رقم الهاتف *</label>
                            <Field type="text" id="phone" name="phone" placeholder="رقم الهاتف" />
                            <ErrorMessage name="phone" component="div" className="error-message" />
                        </div>

                        <div className="form-group">
                            <label htmlFor="email">البريد الإلكتروني *</label>
                            <Field type="email" id="email" name="email" placeholder="أدخل البريد الإلكتروني" />
